...
export const updatePostUser = (id_post, updatedPost) => {
    return async function (dispatch) {
      try {
        ...
        const { data } = await axios.put(`/posts/${id_post}`, cleanedPost);
...
export const deleteComment = (id_comments) => {
    return async function (dispatch) {
        const { data } = await axios.delete(`/comments/${id_comments}`);
...
export const modifyPostUser = (postData) => {
    return async function (dispatch) {
        const { data } = await axios.put(`/posts/${postData.id}`, postData);
...
export const createCommentPost = (postData) => {
    return async function (dispatch) {
        const { data } = await axios.post(`/comments`, postData);
...
export const modifyRol = (postData) => {
    return async function (dispatch) {
        const { data } = await axios.patch(`/admin/`, postData);
...
export const activeUser = (full_name) => {
    return async function (dispatch) {
        const { data } = await axios.patch(`/company/active/${full_name}`);
...
export const desactiveUser = (full_name) => {
    return async function (dispatch) {
        const { data } = await axios.patch(`/company/desactive/${full_name}`);
...
export const createPublication = (publicationData) => {
    return async function (dispatch) {
      try {
        const { data } = await axios.post("/posts", publicationData);
